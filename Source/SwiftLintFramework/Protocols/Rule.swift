...
public protocol Rule {
    ...
    func validate(file: SwiftLintFile, additionalInfo: AdditionalInfo) -> [StyleViolation]
    ...
    /// - parameter compilerArguments: The compiler arguments needed to compile this file.
    func collectInfo(for file: SwiftLintFile, into storage: RuleStorage, additionalInfo: AdditionalInfo)
    ...
    ///
    /// - returns: All style violations to the rule's expectations.
    func validate(file: SwiftLintFile, using storage: RuleStorage, additionalInfo: AdditionalInfo) -> [StyleViolation]
}

extension Rule {
    public func validate(file: SwiftLintFile, using storage: RuleStorage,
                         additionalInfo: AdditionalInfo) -> [StyleViolation] {
        return validate(file: file, additionalInfo: additionalInfo)
    }
    ...
    public func collectInfo(for file: SwiftLintFile, into storage: RuleStorage, additionalInfo: AdditionalInfo) {
...
public protocol CorrectableRule: Rule {
    ...
    func correct(file: SwiftLintFile, additionalInfo: AdditionalInfo) -> [Correction]
    ...
    ///
    /// - returns: All corrections that were applied.
    func correct(file: SwiftLintFile, using storage: RuleStorage, additionalInfo: AdditionalInfo) -> [Correction]
}
...
public extension CorrectableRule {
    ...
    func correct(file: SwiftLintFile, using storage: RuleStorage, additionalInfo: AdditionalInfo) -> [Correction] {
        return correct(file: file, additionalInfo: additionalInfo)
    }
}
...
public protocol CollectingRule: AnyCollectingRule {
    ...
    func collectInfo(for file: SwiftLintFile, additionalInfo: AdditionalInfo) -> FileInfo
...
public extension CollectingRule {
    func collectInfo(for file: SwiftLintFile, into storage: RuleStorage, additionalInfo: AdditionalInfo) {
        storage.collect(info: collectInfo(for: file, additionalInfo: additionalInfo),
                        for: file, in: self)
    }
    func validate(file: SwiftLintFile, using storage: RuleStorage, additionalInfo: AdditionalInfo) -> [StyleViolation] {
        ...
        return validate(file: file, collectedInfo: info, additionalInfo: additionalInfo)
    }
    func collectInfo(for file: SwiftLintFile, additionalInfo: AdditionalInfo) -> FileInfo {
...
public extension CollectingCorrectableRule {
    ...
    func correct(file: SwiftLintFile, using storage: RuleStorage, additionalInfo: AdditionalInfo) -> [Correction] {
        ...
        return correct(file: file, collectedInfo: info, additionalInfo: additionalInfo)
    }
    func correct(file: SwiftLintFile) -> [Correction] {
